...
|---------|------|
| `SKILL.md` | スキル本体（実行手順） |
| `reference/compaction.md` | compaction 耐性の構築（テンプレート一式） |
| `reference/harness-evolution.md` | hook・ルール育成の仕組み |
| `reference/completion.md` | セットアップ完了報告 |
| `reference/agent-table.md` | 活動タイプ別エージェント対応表 |
| `reference/agent-template.md` | PJ固有エージェント作成ガイド |
